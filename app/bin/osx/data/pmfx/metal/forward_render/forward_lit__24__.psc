...
, constant c_cbuffer_gi_volume &cbuffer_gi_volume [[buffer(15)]]
, constant c_material_data &material_data [[buffer(11)]])
{
    ...
    constant float4& gi_scene_size = cbuffer_gi_volume.gi_scene_size;
    constant float4& gi_volume_size = cbuffer_gi_volume.gi_volume_size;
