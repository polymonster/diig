...
, constant c_gi_info &gi_info [[buffer(5)]])
{
    constant float4& scene_size = gi_info.scene_size;
    constant float4& volume_size = gi_info.volume_size;
    constant float4& shadow_map_size = gi_info.shadow_map_size;
    constant float4x4& inv_mat = gi_info.inv_mat;
